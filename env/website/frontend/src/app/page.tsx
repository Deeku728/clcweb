...
// }
function Hero() {
  const slideshowVideos = ["/a.mp4", "/b.mp4"]; // public/
  const [index, setIndex] = useState(0);
...
const navItems = [
  ...
  { href: "./home/about", label: "About Us", icon: <FaEnvelope /> },
...
<div className="sticky top-0 z-50 border-b border-gray-800 bg-black/70 backdrop-blur-lg">
  ...
  {/* Navigation Bar */}
  <div className="relative hidden md:flex items-center gap-2 px-6 py-2.5 rounded-full bg-gradient-to-r from-gray-800 via-gray-900 to-black border border-gray-600 shadow-2xl overflow-hidden">
...
<section id="contact" className="mx-auto max-w-7xl px-4 py-10 bg-gray-50">
  ...
  <div className="grid md:grid-cols-2 gap-8 mt-6">
    {/* Contact Form */}
    <form onSubmit={handleLeadSubmit} className="space-y-4 bg-white p-5 rounded-xl shadow-md">
      <Input
    ...
    <div className="space-y-4 text-gray-900">
      <p className="flex items-center">
        <Mail className="inline h-5 w-5 mr-2 text-indigo-600" /> Info@careerlabconsulting.com
      </p>
      <p className="flex items-center">
        <Phone className="inline h-5 w-5 mr-2 text-indigo-600" /> +91 87002 36923
      </p>
...
<section className="bg-gray-900 text-white py-4 px-4">
  <div className="max-w-4xl mx-auto text-center">
    ...
    <p className="mb-6 text-gray-300">Get the latest updates and offers right in your inbox.</p>
    ...
    <div className="flex flex-wrap justify-between gap-12 text-sm">
      ...
      <div className="flex-1 min-w-[220px]">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            "AI & Generative AI","Cloud","Engineering","Software",
            "Business Process Operations","Cybersecurity","Data and AI",
            "Digital Design and Manufacturing Services","Digital Engineering",
            "Digital Workplace","EdTech","Enterprise Applications Transformation",
            "Enterprise Platforms and Edge Services","Enterprise Transformation Advisory",
            "Global Capability Center (GCC)","Intelligent Operations","Modern Applications",
            "Networks","Operational Technology","Physical AI and AIoT","Product Engineering",
            "Supply Chain","Unified Service Management (USM)"
          ].map((item) => (
            <a 
              key={item} 
              href="#" 
      ...
      <div className="flex-1 min-w-[220px]">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            "Aerospace and Defense","Automotive","Consumer Goods","Energy and Utilities",
            "Life Sciences and Healthcare","Manufacturing","Mining and Natural Resources",
            "Oil and Gas","Public Sector","Retail","Technology",
            "Telecom Media and Entertainment Services","Travel, Transport, Logistics & Hospitality",
            "Financial Services","Banking","Capital Markets",
            "Financial Crime Compliance and Risk","Fintech","Insurance"
          ].map((item) => (
            <a 
              key={item} 
              href="#" 
      ...
      <div className="flex-1 min-w-[220px]">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            "Who We Are","About Us","Analyst Recognitions","Annual Report 2025",
            "Awards and Recognition","Code of Business Ethics and Conduct",
            "Corporate Social Responsibility","Diversity, Equity and Inclusion",
            "Global Presence","Investor Relations","Leadership","Newsroom",
            "Privacy Trust Center","Strategic Alliances","Sustainability"
          ].map((item) => (
            <a 
              key={item} 
              href="#" 
      ...
      <div className="flex-1 min-w-[220px]">
        ...
        <div className="flex flex-wrap gap-2">
          {["Trends and Insights","Case Studies","Events and Webinars"].map((item) => (
            <a 
              key={item} 
              href="#" 
              className="px-2 py-0.5 border border-gray-800 rounded hover:border-gray-500 hover:text-gray-200 transition"
        ...
        <div className="flex flex-wrap gap-2">
          {[
            "Careers Overview","Meet our people","Explore job opportunities",
            "Careers by LoB","Americas","Asia Pacific","Europe and Africa","India"
          ].map((item) => (
            <a 
              key={item} 
              href="#" 
        ...
        <h4 className="font-semibold text-white mt-5 mb-3">Global Presence</h4>
        <div className="flex flex-wrap gap-2">
...
<div className="flex flex-col md:flex-row justify-between items-center text-xs gap-4">
  <div className="flex flex-wrap gap-2 text-gray-400">
    {[
      { name: "Facebook", url: "https://www.facebook.com/careerlabconsultingofficial" },
      { name: "Twitter", url: "https://x.com/CareerLabConsul" },
      { name: "LinkedIn", url: "https://www.linkedin.com/company/38144534" },
      { name: "Instagram", url: "https://www.instagram.com/careerlabconsultingofficial" },
      { name: "YouTube", url: "https://www.youtube.com/@careerlabconsulting4691" },
      { name: "Threads", url: "https://www.instagram.com/careerlabconsultingofficial" },
      { name: "Quora", url: "https://www.quora.com/profile/Career-Lab-Consulting-2" },
      { name: "Reddit", url: "https://www.reddit.com/user/Fantastic_Offer861/" }
    ].map((item) => (
      <a
        key={item.name}
        href={item.url}
    ...
    <div className="flex flex-wrap justify-center gap-2 text-gray-600">
      {[
        ...
        <Link key={link.name} href={link.href} className="px-2 py-0.5 border border-gray-800 rounded hover:border-gray-500 hover:text-gray-200 transition">
          {link.name}
        </Link>
      ))}
    </div>
